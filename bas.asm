...
LA02A	LDX	#PIA1	POINT X TO PIA1
	...
	LDB	#13	13 SAM CONTROL REGISTER BITS - Don't Clear the last one, leave in all RAM mode. Don't touch RAM mode.
...
*LA06E	NOP
*	NOP
* Subsequent comment is wrong
* This sets double speed mode for ROM mode
...
LBFFE	FDB	RESVEC	RESET
 ...
 IFGT *-$FEFF
 ERROR Color BASIC ends past $FEFF
 ENDC
